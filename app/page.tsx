...
export default function HomePage() {
  ...
  return (
   ...
   {/* ============================================================================
            🏢 3. CORPORATE STATS (อัปเกรด UI พรีเมียม & แก้ข้อความบรรทัดเดียว)
        ============================================================================ */}
        <section className="relative py-28 px-4 sm:px-6 lg:px-8 overflow-hidden bg-white">
          
          {/* พื้นหลังแบบมีมิติ (Subtle Gradient & Glow) */}
          ...
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-full opacity-40 z-0 pointer-events-none">
            <div className="absolute -top-24 -left-20 w-96 h-96 bg-blue-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30"></div>
            <div className="absolute top-20 -right-20 w-96 h-96 bg-red-100 rounded-full mix-blend-multiply filter blur-3xl opacity-40"></div>
          </div>

          <div className="max-w-7xl mx-auto relative z-10">
            
            {/* ส่วนหัวข้อ (เอา <br> ออก และปรับขนาดฟอนต์ให้ยืดหยุ่นเรียงบรรทัดเดียว) */}
            <div className="text-center mb-20">
              ...
              {/* ไฮไลท์คำว่า 20 ปี ด้วยสี Gradient ให้ดูน่าสนใจ */}
            ...
            {/* การ์ดสถิติ (อัปเกรดดีไซน์แบบ Modern Card) */}
